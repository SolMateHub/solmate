...
if not exist .env (
    ...
    echo MAINNET_RPC=your_helius_rpc_endpoint >> .env
    echo ✅ .env file created. Please update it with your bot token and required Helius RPC endpoint.
)
